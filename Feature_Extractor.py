...
def Feature_Extractor_2_Etapa(face, Type_features):
    ...
    if Type_features == "Color_quotient":
        ...
        X = np.array([[rgl1, rgu1, rbl1, rbu1, rgq1, rbq1, rgl2, rgu2, rbl2, rbu2, rgq2, rbq2, h, w, h/w]])

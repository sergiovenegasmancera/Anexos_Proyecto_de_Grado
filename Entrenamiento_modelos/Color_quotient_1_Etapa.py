...
#Gamma= 100
#print('gamma = '+f'{Gamma}')
#msv = svm.SVC(kernel=kernels[Kernel],gamma = Gamma, C = 1)
#msv.fit(X_train, y_train)
...
joblib.dump(msv, '/home/pi/Desktop/Proyecto_de_Grado/Modelos/Classifiers/SVM/Clasificador_Color_quotient_1_Etapa.pkl') # Guardo el modelo.

...
classifier = KNeighborsClassifier(algorithm = 'auto', metric = 'minkowski', n_neighbors =  67, weights = 'distance')
classifier.fit(X_train, y_train)
...
joblib.dump(classifier, '/home/pi/Desktop/Proyecto_de_Grado/Modelos/Classifiers/KNN/Clasificador_Color_quotient_1_Etapa.pkl') # Guardo el modelo.


clf = KNeighborsClassifier(algorithm = 'auto', metric = 'minkowski', n_neighbors =  67, weights = 'distance')

...
############################################################################################################
dataframe = pd.read_csv(r'/home/pi/Desktop/Proyecto_de_Grado/Features/Texture_2_Etapa.csv')
############################################################################################################
y = dataframe['label']
...
#joblib.dump(scaler, '/home/pi/Desktop/Proyecto_de_Grado/Modelos/Scalers/Scaler_Texture_2_Etapa.pkl') # Guardo el modelo.
...
classifier = KNeighborsClassifier(algorithm = 'auto', metric = 'manhattan', n_neighbors =  46, weights = 'distance')
classifier.fit(X_train, y_train)
...
joblib.dump(classifier, '/home/pi/Desktop/Proyecto_de_Grado/Modelos/Classifiers/KNN/Clasificador_Texture_2_Etapa.pkl') # Guardo el modelo.


clf = KNeighborsClassifier(algorithm = 'auto', metric = 'manhattan', n_neighbors =  46, weights = 'distance')

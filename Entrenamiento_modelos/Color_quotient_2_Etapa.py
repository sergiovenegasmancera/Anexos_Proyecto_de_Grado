...
#Gamma= 10
#print('gamma = '+f'{Gamma}')
#msv = svm.SVC(kernel=kernels[Kernel],gamma = Gamma, C = 5)
#msv.fit(X_train, y_train)
...
joblib.dump(msv, '/home/pi/Desktop/Proyecto_de_Grado/Modelos/Classifiers/SVM/Clasificador_Color_quotient_2_Etapa.pkl') # Guardo el modelo.
...
#clf = svm.SVC(kernel=kernels[Kernel],gamma = Gamma, C = 5, random_state=42)
#scores = cross_val_score(clf, X_train, y_train, cv = 10)
#print("%0.2f accuracy with a standard deviation of %0.2f" % (scores.mean(), scores.std()))
#print('Best:', max(scores))
